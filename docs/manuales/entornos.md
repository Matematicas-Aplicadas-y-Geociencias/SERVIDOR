...
<div class="tab-content">
  ...
  <div role="tabpanel" class="tab-pane" id="linux">
    ...
    <pre>
<code>wget https://github.com/conda-forge/miniforge/releases/latest/download/Miniforge3-Linux-x86_64.sh</code></pre>
